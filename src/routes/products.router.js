...
router.post('/', verifyToken, userIsAdmin,  isUserPremium, (req, res) => controller.addProduct(req, res));
router.put('/:pid', verifyToken, userIsAdmin, (req, res) => controller.updateProduct(req, res));
router.delete('/:pid', verifyToken, userIsAdmin, isUserPremium, canDeleteProduct,(req, res) => controller.deleteProduct(req, res));
